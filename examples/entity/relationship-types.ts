...
type Invoice = { id: Entity.Key.Primary<Entity.Integer>; order_id: Entity.Key.Foreign<Entity.Integer> };
...
type Sale = { id: Entity.Key.Primary<Entity.Integer>; customer_id: Entity.Key.Foreign<Entity.Integer> };
type Item = { id: Entity.Key.Primary<Entity.Integer>; supplier_id: Entity.Key.Foreign<Entity.Integer> };

export type Cardinalities = Render<Entity.Diagram<[
