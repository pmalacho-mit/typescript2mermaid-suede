import type { Render, Journey } from "../../release/dsl.js";

type ProductManager = {};
type Developer = {};
type DevOps = {};

export type DevelopmentLifecycle = Render<Journey.Diagram<"Software Development Lifecycle", [
  Journey.Section<"Planning", [
